...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleMultiChoice = function (_H5P$EventDispatcher) {
	  ...
	  function SimpleMultiChoice(_ref) {
	    ...
	    var _this = _possibleConstructorReturn(this, (SimpleMultiChoice.__proto__ || Object.getPrototypeOf(SimpleMultiChoice)).call(this));
	    ...
	    _this.attach = function ($wrapper) {
	      ...
	      var questionText = this.createQuestion();
	      questionElement.appendChild(questionText);

	      element.appendChild(questionElement);

	      var altList = this.createAlternativesList(alternatives);
	     ...
	     */
	    _this.createAlternativesList = function () {
	      var _this2 = this;
